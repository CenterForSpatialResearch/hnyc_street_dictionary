...
library(purrr)
```
# Note: for mn output, you need to run mn codes twice.
...
```{r}
write_csv(full_mn_dict, "Data/full_mn_dict1880.csv")
write_csv(full_bk_dict, "Data/full_bk_dict1880.csv")
```
