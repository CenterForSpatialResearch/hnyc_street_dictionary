...
```{r}
mn_seg$MN_STREET1910_FULL_STREE = clean(mn_seg$MN_STREET1910_FULL_STREE)
mn_seg$MN_STREET1910_Y1910NAMEALT = clean(mn_seg$MN_STREET1910_Y1910NAMEALT)
mn_seg$MN_STREET1910_Y1910NAMESTREET = clean(mn_seg$MN_STREET1910_Y1910NAMESTREET)

bk_seg$BK_STREET1910_FULL_STREE = clean(bk_seg$BK_STREET1910_FULL_STREE)
bk_seg$BK_STREET1910_Y1910NAMEALT = clean(bk_seg$BK_STREET1910_Y1910NAMEALT)
bk_seg$BK_STREET1910_Y1910NAMESTREET = clean(bk_seg$BK_STREET1910_Y1910NAMESTREET)
```
...
mn_seg <- mn_seg %>% rowwise() %>% 
  mutate(Name = ifelse(Name1910 != "NULL", Name1910, 
